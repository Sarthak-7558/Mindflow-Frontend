...
const features = [
  ...
  },
  {
    ...
    description:
      "Your therapy sessions are protected with enterprise-grade encryption, ensuring complete privacy and secure record-keeping.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Detailed analytics and insights about your mental health journey, with secure and verified session records.",
  },
  {
    icon: <Fingerprint className="w-10 h-10 text-primary" />,
    title: "Privacy First",
    description:
      "End-to-end encryption and advanced security protocols ensure your data remains completely confidential.",
  },
  {
