...
import { ScheduleCallModal } from "@/components/therapy/schedule-call-modal";
...
export default function Dashboard() {
  ...
  const fetchDailyStats = useCallback(async () => {
    try {
      ...
      // Fetch today's activities with auth token
      ...
      if (!activitiesResponse.ok) {
        console.warn("Failed to fetch activities, using default values");
  ...
  }, [loadActivities, isAuthenticated]);
  ...
  const handleTherapistSelected = (therapist: Therapist) => {
    // Store selected therapist in localStorage for the voice agent page
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-3">
                    ...
                    <Button
                      ...
                      className={cn(
                        "w-full justify-between items-center p-6 h-auto group/button",
                        "bg-gradient-to-r from-purple-600/90 to-purple-700 hover:from-purple-600 hover:to-purple-700/90",
                        "transition-all duration-200 group-hover:translate-y-[-2px]"
                      )}
                    ...
                    <Button
                      variant="outline"
                      className={cn(
                        "w-full flex items-center justify-center gap-2 h-[60px] hover:border-purple-500/50 hover:bg-purple-500/5",
                        "transition-all duration-200 group-hover:translate-y-[-2px]"
                      )}
