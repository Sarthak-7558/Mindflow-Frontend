...
const missions = [
  {
    ...
    title: "Our Mission",
    description:
      "To democratize access to mental health support through ethical AI technology, making quality therapeutic care available to everyone, everywhere, at any time.",
  },
  {
    icon: <Target className="w-8 h-8 text-primary" />,
    title: "Our Vision",
    description:
      "A world where mental health support is accessible, private, and personalized, powered by trusted AI agents with the highest standards of security.",
  },
  {
    ...
    <div className="container mx-auto px-4 py-24">
      ...
      >
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          AI technology with advanced security and privacy protection.
        </p>
      </motion.div>
