# MindFlow: AI-Powered Mental Health Support on Sonic 🧠⛓️
...
<div align="center">
  <img src="https://i.imghippo.com/files/uath6507iKU.png" alt="MindFlow Dashboard" width="45%" />
...
1. **Clone & Install**
   ...
   ```bash
   git clone https://github.com/blocklinklabs/MindFlow.git
   cd MindFlow
   npm install
   ```
